...
export default function HomePage() {
  return (
    <div className="w-full flex flex-col gap-4 md:gap-6 animate-in fade-in duration-500">
      <div className="w-full bg-black/3 dark:bg-white/3 backdrop-blur-2xl rounded-[3rem] p-10 md:p-12 border border-black/10 dark:border-white/10 shadow-2xl relative overflow-hidden group">
